...
![メニューバー画面](images/menu-bar-screenshot.png)
...
![履歴管理画面](images/history-screen-screenshot.png)
...
![スニペット管理画面](images/snippet-screen-screenshot.png)
...
![フォルダ編集画面](images/folder-edit-screenshot.png)
